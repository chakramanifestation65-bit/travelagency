        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <ul className="space-y-3 mb-6">
              {visaCountries.map((v) => (
                <li key={v.country} className="flex items-start gap-3">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-marigold hover:bg-marigold/90 text-indigo-night font-bold text-sm px-6 py-3.5 rounded-lg transition-colors"
            >
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-5 -left-5 bg-indigo-night text-warm-ivory rounded-xl p-5 shadow-lg hidden sm:block">
              <div className="text-xs font-semibold text-warm-ivory/60 mb-1">Success rate</div>
              <p className="font-display font-bold text-2xl text-marigold">95%+</p>
